...
const ExoMobileBanner: React.FC = () => {
  useEffect(() => {
    ...
    adElement.setAttribute('data-zoneid', '5513350');

    // Append the ad element to the placeholder in the component
    const placeholder = document.getElementById('exo-banner-placeholder');
    if (placeholder) {
  ...
  return (
    <div>
      ...
      <div id="exo-banner-placeholder" style={{ textAlign: 'center' }}></div>
    </div>
  );
};
