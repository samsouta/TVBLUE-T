...
const ExoMobileInstantMessage: React.FC = () => {
  useEffect(() => {
    ...
    adElement.className = 'eas6a97888e6';
    adElement.setAttribute('data-zoneid', '5513338');

    // Append the ad element to the placeholder in the component
    const placeholder = document.getElementById('exo-instant-message-placeholder');
    if (placeholder) {
  ...
  return (
    <div>
      {/* Placeholder for the instant message ad */}
      <div id="exo-instant-message-placeholder" style={{ textAlign: 'center' }}></div>
    </div>
  );
};

export default ExoMobileInstantMessage;
