...
const JuicyBannerMobileImg2: React.FC = () => {
    useEffect(() => {
        ...
        juicyIns.id = '1077719';
        juicyIns.setAttribute('data-width', '125');
        juicyIns.setAttribute('data-height', '125');
        ...
        juicyInlineScript.text = `(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1077719});`;

        // Get the container to append ads elements
        const container = document.getElementById('juicy-img2-container');
        if (container) {
...
export default JuicyBannerMobileImg2;
