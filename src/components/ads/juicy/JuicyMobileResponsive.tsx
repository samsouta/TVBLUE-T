...
const JuicyMobileResponsive: React.FC = () => {
  useEffect(() => {
    ...
    juicyIns.setAttribute('data-height', '100');
    ...
    juicyInlineScript.text = `(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1077736});`;
...
export default JuicyMobileResponsive;
