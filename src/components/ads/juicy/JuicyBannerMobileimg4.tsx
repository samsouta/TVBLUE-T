...
const JuicyBannerMobileimg4: React.FC = () => {
    useEffect(() => {
        ...
        juicyIns.id = '1077726';
        juicyIns.setAttribute('data-width', '158');
        juicyIns.setAttribute('data-height', '168');
        ...
        juicyInlineScript.text = `(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1077726});`;

        // Get the container to append ads elements
        const container = document.getElementById('juicy-banner-mobileimg4-container');
        if (container) {
    ...
    return (
        <div 
        id="juicy-banner-mobileimg4-container" 
        style={{
...
export default JuicyBannerMobileimg4;
