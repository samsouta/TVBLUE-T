...
const JuicyNative: React.FC = () => {
  useEffect(() => {
    ...
    juicyIns.id = '1077733';
    juicyIns.setAttribute('data-width', '474');
    juicyIns.setAttribute('data-height', '190');
    ...
    juicyInlineScript.text = `(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1077733});`;
