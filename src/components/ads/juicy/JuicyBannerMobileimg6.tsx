...
const JuicyBannerMobileimg6: React.FC = () => {
  useEffect(() => {
    ...
    juicyIns.setAttribute('data-height', '50');
    ...
    juicyInlineScript.text = `(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1077728});`;
...
export default JuicyBannerMobileimg6;
