...
const JuicyBillBoard: React.FC = () => {
  useEffect(() => {
    ...
    juicyIns.id = '1077729';
    juicyIns.setAttribute('data-width', '908');
    juicyIns.setAttribute('data-height', '258');
    ...
    juicyInlineScript.text = `(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1077729});`;
