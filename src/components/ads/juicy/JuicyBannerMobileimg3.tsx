...
const JuicyBannerMobileimg3: React.FC = () => {
    useEffect(() => {
        ...
        juicyIns.id = '1077725';
        juicyIns.setAttribute('data-width', '133');
        juicyIns.setAttribute('data-height', '139');
        ...
        juicyInlineScript.text = `(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1077725});`;

        // Get the container to append ads elements
        const container = document.getElementById('juicy-banner-mobileimg3-container');
        if (container) {
    ...
    return (
        <div
         id="juicy-banner-mobileimg3-container"
         style={{
...
export default JuicyBannerMobileimg3;
