...
const JuicyLinkTitle: React.FC = () => {
  useEffect(() => {
    ...
    juicyIns.setAttribute('data-height', '18');
    ...
    juicyInlineScript.text = `(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1077732});`;
